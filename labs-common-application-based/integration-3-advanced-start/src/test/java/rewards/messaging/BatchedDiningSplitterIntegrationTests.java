...
public class BatchedDiningSplitterIntegrationTests {
    ...
    public void inboundSingleDiningXml() throws Exception {
        ...
        assertThat(xpathTemplate.evaluateAsString("/dining/creditcard/@number", receivedXml), is("1234123412340001"));
    ...
    public void inboundMultipleDiningXml() throws Exception {
        ...
        // TODO-06 Send diningsFile to the mixedXmlDinings channel as above

        // TODO-07 For each expected dining, receive and verify as above (check file for content)

        // TODO-08 Verify no unexpected extra message is received, as above
    }
}
